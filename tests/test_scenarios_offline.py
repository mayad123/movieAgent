...
from cinemind.prompting import EvidenceBundle, PromptBuilder, get_template
...
from tests.helpers.failure_artifact_writer import remove_failure_artifact, write_failure_artifact
    ...
    def test_prompt_construction(
        ...
        for section in required_sections:
            if section == "system" and "system" not in message_roles:
                failures.append("Missing required section: system")
                ...
                if "system" not in message_roles:
                    failures.append("Missing required section: developer (combined in system)")
            elif section == "user" and "user" not in message_roles:
                failures.append("Missing required section: user")
