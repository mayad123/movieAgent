...
def main():
    ...
    parser.add_argument(
        '--db',
        default='cinemind.db',
        help='Database file path (default: cinemind.db)'
    )
    parser.add_argument(
        '--output-dir',
        default='data/exports',
        help='Output directory for CSV files (default: data/exports)'
    )
    parser.add_argument(
        '--table',
        choices=['requests', 'responses', 'metrics', 'search_operations', 'all', 'test_results', 'prompt_comparison'],
        default='all',
        help='Which table/data to export (default: all)'
    )
    ...
    if args.table in ['test_results', 'all']:
        export_test_results_to_csv(
            ...
            output_file=str(output_dir / "test_results.csv")
        )
    
    # Export prompt comparison
    if args.table in ['prompt_comparison', 'all']:
        export_prompt_comparison_to_csv(
            comparison_dir="data/prompt_comparison",
            output_file=str(output_dir / "prompt_comparison.csv")
        )
