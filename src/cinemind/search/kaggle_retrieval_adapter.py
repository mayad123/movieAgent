...
class KaggleEvidenceItem:
    ...
    year: int | None = None  # Year for deduplication
    metadata: dict | None = None  # License, author, etc. (internal, not exposed to user)
...
class KaggleRetrievalAdapter:
    ...
    def _is_relevant_for_kaggle(self, prompt: str, intent: str, entities: dict) -> tuple[bool, float]:
        ...
        for _category, keywords in KAGGLE_RELEVANT_KEYWORDS.items():
