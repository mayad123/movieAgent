...
class CacheEntry:
    ...
    structured_facts: dict | None = None  # Structured facts for regeneration
    created_at: str = ""
    expires_at: str = ""
    agent_version: str = ""
    prompt_version: str = ""
    ...
    last_verified_at: str | None = None  # When sources were last verified
...
class PromptNormalizer:
    ...
    def _compute_freshness_bucket(self, need_freshness: bool, freshness_ttl_hours: float | None = None) -> str:
        """
...
class SemanticCache:
    ...
    def _get_exact_match(self, prompt_hash: str) -> CacheEntry | None:
